...
<div class="block ui-tabs-panel deactive" id="option-ourproduct">
	<div class="row-fluid pricing-table pricing-three-column">
		...
		<div class="plan-name">
			...
			<h6><?php _e('Get The Premium & Create Your Website Beautifully.','weblizar'); ?>  </h6>
		</div>
		...
		<div class="section container" id="product_decs">
			<p style="text-align:center;"><?php _e('For more product details visit our official site.','weblizar'); ?></p>	
		</div>
	</div>											
	<div class="plan-name centre"> 
		<div class="purchase_btn_div">
